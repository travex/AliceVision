...
public:
    ...
    void initOutputVolume(CudaDeviceMemoryPitched<TSimRefine, 3>& volBestSim_dmp, TSimRefine value);
    ...
    void add(CudaDeviceMemoryPitched<TSimRefine, 3>& out_volume_dmp,
